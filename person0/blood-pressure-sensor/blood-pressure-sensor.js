...
const firstjoinTopic=scalable+'firstjoin'
const backfirstjoinTopic=scalable+'backfirstjoin/'+deviceName
let nextnodeTopic;
...
function infiniteLoopPublish() {
    ...
    console.log(nextnodeTopic,nearnodetable)
    if((getSensorData(deviceName).systole >140)||(getSensorData(deviceName).distole>90)) {
...
function getSensorData(deviceName) {
    let message = {
        'systole': randomIntBetween(100, 160), //in mmHG
        'distole': randomIntBetween(60, 110),  //in mmHG
    };
